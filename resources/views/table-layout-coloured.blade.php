                                    ...
                                    <table class="table table-hover table-info">
                                        <thead class="text-white">
                                            <tr>
                                                ...
                                                <th class="bg-info" scope="col">First</th>
                                                <th class="bg-info" scope="col">Last</th>
                                                <th class="bg-info" scope="col">Handle</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                    ...
                                    <table class="table table-hover table-warning">
                                        <thead class="text-white">
                                            <tr>
                                                ...
                                                <th class="bg-warning" scope="col">First</th>
                                                <th class="bg-warning" scope="col">Last</th>
                                                <th class="bg-warning" scope="col">Handle</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                    ...
                                    <table class="table table-hover table-dark">
                                        <thead class="text-white">
                                            <tr>
                                                ...
                                                <th class="bg-dark" scope="col">First</th>
                                                <th class="bg-dark" scope="col">Last</th>
                                                <th class="bg-dark" scope="col">Handle</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
